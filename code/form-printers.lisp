...
(defun pprint-with (client stream object &key argument-count newline)
  (pprint-body-form (client stream object)
    ...
    (write-char #\Space stream)
    (pprint-newline client stream :miser)
    (apply #'pprint-argument-list client stream (pprint-pop)
...
(defun pprint-extended-loop (client stream object)
  (pprint-format-logical-block (client stream object :paren t)
    (pprint-exit-if-list-exhausted)
    (incless:write-object client (pprint-pop) stream)
    (pprint-exit-if-list-exhausted)
...
(defun pprint-simple-loop (client stream object)
  (declare (ignore options))
...
(defun pprint-macro-char (client stream object &key prefix)
  (write-string prefix stream)
  (incless:write-object client (second object) stream))

(defun pprint-quasiquote (client stream object &key prefix quote)
  (write-string prefix stream)
